      ...
      <div className="flex relative px-6 md:px-24 flex-col items-center md:items-start justify-center min-h-[80dvh] h-full">
        <div className="flex flex-col items-center md:items-start justify-center gap-4">
          <p className="text-lg text-center md:text-left max-w-2xl">
           This app has been done for learning purposes. The following resources are useful.
          </p>
          <p className="text-lg text-center md:text-left max-w-2xl">
            <ul>
              <li>
                <a href="https://github.com/alienmind/phronex">https://github.com/alienmind/auditorium</a><br/>
              </li>
            </ul>
          </p>
          <p>
          Additional debug actions that can be done from here:
